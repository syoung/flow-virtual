...
method testLaunchNode {
	...
	$self->conf()->setKey("openstack", "OS_USERNAME", $ENV{'osusername'});
	$self->conf()->setKey("openstack", "OS_TENANT_ID", $ENV{'ostenantid'});
	$self->conf()->setKey("openstack", "OS_TENANT_NAME", $ENV{'ostenantname'});
	$self->conf()->setKey("openstack", "OS_AUTH_URL", $ENV{'osauthurl'});
	$self->conf()->setKey("openstack", "OS_PASSWORD", $ENV{'ospassword'});
	$self->conf()->setKey("openstack", "KEYPAIR", $ENV{'keypair'});
	...
	#### LAUNCH NODE
	my $id	=	$self->launchNode($workobject, $amiid, $maxnodes, $instancetype, $name);
	$self->logDebug("id", $id);
...
method testDeleteNode {
	...
	#
	##### LAUNCH NODE
	#my $id	=	$self->launchNode($workflowobject, $amiid, $maxnodes, $instancetype, $name);
	#$self->logDebug("id", $id);
	#
	#sleep($self->sleep());
	#
